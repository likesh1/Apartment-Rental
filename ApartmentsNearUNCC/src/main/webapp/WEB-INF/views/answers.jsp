        ...
        <c:forEach items="${answers}" var="answersList">
          ...
          <div class="panel-body">
                	<div class="table-responsive">    
                		...
                		<tr><td style="text-align: center;">  ${answersList.reply}</td></tr>
                		<tr><td style="text-align: right;"> BY: ${answersList.fname} </td></tr>
         	...
         	<form:form name="AddAnswer" method="post" onsubmit="return validateReply(this);" action="addanswer.do" modelAttribute="answerbean">
				   	...
				   	<form:textarea  id="reply" name="reply" path="reply" rows="3" cols="30" />
				   	<br>
				   	<label id="ErrorMessage">${questionErrorMessage}</label><br/>
				   <button class="btn btn-primary" type="submit" id="Reply" >Reply</button>				 
				   </form:form>
				   </div>
				   </div>
				   </div>	
